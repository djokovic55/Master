...
HD_PWD='C:/Users/L340/Desktop/DS otporni na greske/fir2_projekat/fir2/fir2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_structure.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_structure.tcl
